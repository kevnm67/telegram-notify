...
common_setup() {
    ...
    unset CIRCLE_TOKEN TELEGRAM_CHAT_ID TELEGRAM_NOTIFY_CUSTOM_MESSAGE \
        ...
        MOCK_ANTHROPIC_BODY MOCK_ANTHROPIC_HTTP_CODE MOCK_ANTHROPIC_FIRST_BODY MOCK_TELEGRAM_DOC_BODY MOCK_DOC_HTTP_CODE
    rm -f "${TMPDIR}/telegram_notify_job_failed" "${TMPDIR}/telegram_notify_failed_step.log" "${MOCK_CURL_LOG}.ai-called"
